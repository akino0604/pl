...
and trans' : Sm5.command -> Sonata.command = function
  ...
  | Sm5.CALL :: cmds ->
    (match cmds with
     ...
     | _ -> Sonata.MALLOC :: Sonata.BIND "temploc!" :: Sonata.PUSH (Sonata.Id "temploc!") :: Sonata.STORE :: Sonata.MALLOC :: Sonata.BIND "tempval!" :: Sonata.PUSH (Sonata.Id "tempval!") :: Sonata.STORE :: Sonata.MALLOC :: Sonata.BIND "tempfun!" :: Sonata.PUSH (Sonata.Id "tempfun!") :: Sonata.STORE :: Sonata.PUSH (Sonata.Fn ("last!", trans' cmds)) :: Sonata.PUSH (Sonata.Id "tempfun!") :: Sonata.LOAD :: Sonata.PUSH (Sonata.Id "tempval!") :: Sonata.LOAD :: Sonata.PUSH (Sonata.Id "temploc!") :: Sonata.LOAD :: Sonata.CALL :: (trans' cmds)) 
